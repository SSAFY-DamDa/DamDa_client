...
const startDate = props.journey.startDate.slice(0, 10);
...
<template>
  <div class="journey-item-section" @click="handleClickJourney(journey.id)">
    ...
    <div class="journey-item">
      <div id="journey-date">{{ startDate }} ~ {{ endDate }}</div>
    </div>
  </div>
</template>

<style scoped>
.journey-item-section {
  height: auto;
  padding: 20px 20px;
  margin: 10px;
  display: flex;
